...
public static void Run(string input, TraceWriter log)
{
    ...
    var simplifier = new SimplifyUtility();
    var simple = simplifier.Simplify(points, 5, false);
    log.Info($"C# manually triggered function called with input: {input}, result points count = " + simple.Length);
}